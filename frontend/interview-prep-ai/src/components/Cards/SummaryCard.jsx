...
const SummaryCard = ({
  ...
  return (
    <div
      className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer 
    hover:shadow-xl shadow-gray-100 relative group"
      onClick={onSelect}
    >
      <div
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
          <div className="text-[15px] font-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-full">
        ...
        <p className="text-[16px] text-gray-500 font-medium line-clamp-2 mt-3">
          {description}
        </p>
      </div>
    </div>
